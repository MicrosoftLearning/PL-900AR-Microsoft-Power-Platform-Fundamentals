...
3. حدد **Microsoft Dataverse**.

4. حدد المشغل **عند إنشاء صف أو تحديثه أو حذفه**.

   * حدد **إنشاء** في **نوع التغيير**
...
13.  أدخل التالي في حقل **النص**. إن **الاسم** هو محتوى ديناميكي من خطوة **الحصول على مبنى**.
