---
lab:
    title: 'لنشاط المعملي 2: كيفية إنشاء تطبيق اللوحة، الجزء 1'
...
في الوقت الذي تمر فيه التطبيقات بعملية تحديث لتجربة المستخدمين، سنجد أن بعض المراجع لمصطلحات Microsoft Dataverse مثل العنصر (الآن **الجدول**)، والحقل (الآن **العمود**)، والتسجيل (الآن **صف**) قد تكون قديمة. يرجى وضع ذلك في الاعتبار أثناء عملك خلال الأنشطة المعملية.
...
2.  أنشئ تطبيق لوحة جديدًا
    ...
    -   انقر فوق **تطبيق جديد** وحدد ** اللوحة**.

    -   حدد **تخطيط الهاتف** المدرج تحت **Common Data Service**.

3.  حدد **إنشاء** المدرج تحت اتصال **Common Data Service**

4.  تحديد جدول **الزيارات**

5.  انقر فوق **اتصال**

6.  قد تظهر نافذة **ترحيب إلى Power Apps Studio**. انقر فوق **تخطي**.

7.  احفظ التطبيق

    -   انقر فوق **ملف \> حفظ**.

    -   أدخل **(اسم العائلة) Campus Staff** كاسم التطبيق.
...
2. وسع **شاشة التفاصيل1** المدرجة تحت **العرض الشجري**

3.  حدد **نموذج التفاصيل1**
...
1.  وسع **شاشة التحرير1** المدرجة تحت **العرض الشجري**

2.  حدد **نموذج التحرير1**
...
1.  وسع **شاشة التصفح1** المدرجة تحت **العرض الشجري**
...
6.  في خانة المعادلة في الأعلى، غيّر **ThisItem.'Created On'** إلى `ThisItem.Stchedched Start`
...
7. مع تحديد **معرض التصفح1** انقر فوق علامة التبويب **خيارات متقدمة** في جزء الخصائص.
...
1.  بدء التطبيق
    ...
    -   حدد **شاشة التصفح1** واضغط على وظيفة **F5** أو انقر فوق أيقونة **تشغيل** في الزاوية العلوية اليمنى لمعاينة التطبيق.
    ...
    -   أنشئ زيارتين أخريتين على الأقل.
...
1. افتح حل Campus Management.
   ...
   * إذا لم تكن البيئة المعروضة في أعلى المين هي بيئة التمرين الخاصة بك، فحدد بيئتك. 
