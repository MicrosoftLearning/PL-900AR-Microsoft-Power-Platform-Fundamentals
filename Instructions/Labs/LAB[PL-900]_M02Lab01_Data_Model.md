---
lab:
    title: 'لنشاط المعملي 1: وضع البيانات في نموذج'
    module: 'لوحدة 2: مقدمة إلى Microsoft Dataverse'
---
...
3. إنشاء عمود البدء المجدول
   ...
   * تأكد من تحديد علامة التبويب الأعمدة وانقر فوق **إضافة عمود**.
...
1. يجب أن يكون لديك ملف **DataImport_managed.zip** مخزن على سطح المكتب. نزل [حل استيراد البيانات](https://github.com/MicrosoftLearning/PL-900-Microsoft-Power-Platform-Fundamentals/blob/update-march-2021/Allfiles/DataImport_managed.zip?raw=true) إذا لم تقم بذلك.
